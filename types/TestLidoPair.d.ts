...
interface TestLidoPairInterface extends ethers.utils.Interface {
  functions: {
...
export class TestLidoPair extends Contract {
  ...
  interface: TestLidoPairInterface;
  ...
  functions: {
    ...
    "swapSimulation((uint8,address,address,uint256,bytes32,uint256,address,address,bytes),uint256,uint256,uint256,uint256,uint256)"(
      request: {
        kind: BigNumberish;
        tokenIn: string;
        tokenOut: string;
