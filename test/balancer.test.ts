...
import { LidoPairFactory } from "../types/LidoPairFactory";
import { LidoPairFactory__factory } from "../types/factories/LidoPairFactory__factory";
import { TestERC20__factory } from "../types/factories/TestERC20__factory";
import { TestVault__factory } from "../types/factories/TestVault__factory";
import { TestLidoPair } from "../types/TestLidoPair";
import { TestERC20 } from "../types/TestERC20";
import { Vault } from "../types/Vault";
import { createSnapshot, restoreSnapshot } from "./helpers/snapshots";
import { TestLidoPair__factory } from "../types/factories/TestLidoPair__factory";
...
describe("ConvergentCurvePool", function () {
  ...
  describe("Balancer Fees Collected Properly", async () => {
    ...
    before(async () => {
      ...
      const curvePoolDeployer = new TestLidoPair__factory(
        tokenSigner
      );
      ...
      aliasedVault = TestLidoPair__factory.connect(
        testVault.address,
        tokenSigner
      );
    });
